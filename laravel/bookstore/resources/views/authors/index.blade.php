...
<html lang="en">
    ...
    <body>
        ...
        <nav
            class="container-fluid navbar navbar-expand-md navbar-light position-sticky top-0"
        >
            <button
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav w-100 justify-content-center">
                    <li class="nav-item">
                        <a class="nav-link py-3 px-4 active" href="./index.php"
                            >Catálogo</a
                        >
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul
                            class="dropdown-menu m-0 border-0"
