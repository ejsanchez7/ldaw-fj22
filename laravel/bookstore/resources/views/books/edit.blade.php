...
@section("pageTitle", "Editar Libro - " . $book->title)
...
@section("mainContent")
    ...
    >
            ...
            <select class="form-select w-50" id="publisher" name="publisher" required>
                ...
                @foreach($publishers as $publisher)
                    ...
                    <option 
                        ...
                        @selected(old('publisher', $book->publisher_id) == $publisher->id)
                    >
                        {{ $publisher->name }}
                    </option>
        ...
        <div class="form-group mb-3">
            ...
            <textarea class="form-control" id="summary" name="summary" >{{ old("summary", $book->summary) }}</textarea>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <select class="form-select w-25" id="language" name="language" required>
                ...
                @foreach($languages as $lang)
                    ...
                    <option 
                        value="{{ $lang->id }}"  
                        @selected(old('language', $book->language_id) == $lang->id) 
                    >
                        {{ $lang->name }}
                    </option>
